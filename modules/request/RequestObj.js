...
const Impl = Java.type("com.github.synnerz.akutz.engine.impl.Impl")

const openConnection = (url) => Impl.openConnection(url)
    ...
    try {
      ...
      if (options.method === 'POST') {
        if (typeof options.body === 'object') {
          ...
          // hopefully this works otherwise... not my problem
          const bytes = encodeURIComponent(params)
