...
declare global {
  ...
  class World extends EmptyClass implements JavaClass<'com.github.synnerz.akutz.api.wrappers.World'> {
     ...
     */
    static getBlockStateAt(
      pos: JavaClass<'net.minecraft.util.BlockPos'>
    ): JavaClass<'net.minecraft.block.state.IBlockState'>;
    /**
     ...
     */
    static getAllBlocksInBox(
      start: JavaClass<'net.minecraft.util.BlockPos'>,
      end: JavaClass<'net.minecraft.util.BlockPos'>
    ): Block[];
    /**
     * * Gets all the blocks that are within the specified position
     */
